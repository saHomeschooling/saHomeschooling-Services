...
const CSS = `:root{ --accent: #f97316; --accent-dark: #ea580c; --accent-light: #f0dcc8; --dark: #3a3a3a; --mid: #555; --muted: #888; --card-gray: #d6d0c8; --card-white: #ede9e3; --border: rgba(0,0,0,0.10); --header-h: 68px; --shadow-md: 0 4px 20px rgba(0,0,0,0.09); --shadow-lg: 0 16px 48px rgba(0,0,0,0.14); --radius: 8px; --radius-lg: 12px; }
...
.sah-rhdr-ghost { padding: 7px 16px; border-radius: 6px; border: 1.5px solid rgba(255,255,255,0.60); background: transparent; color: #fff; font-weight: 600; font-size: 0.85rem; cursor: pointer; font-family: 'DM Sans', sans-serif; text-decoration: none; display: inline-flex; align-items: center; gap: 6px; }
...
.sah-step-trail { display: flex; align-items: center; gap: 0; flex-wrap: nowrap; overflow-x: auto; -webkit-overflow-scrolling: touch; padding-bottom: 4px; }
...
.sah-trail-dot.active { background: var(--accent); color: #fff; border-color: var(--accent); box-shadow: 0 0 0 3px rgba(249,115,22,0.28); }
...
.sah-plan-card.selected { border-color: var(--accent); box-shadow: 0 0 0 3px rgba(249,115,22,0.18), var(--shadow-md); }
...
.sah-terms-row.checked { border-color: var(--accent); background: rgba(249,115,22,0.05); }
...
.sah-field input:focus, .sah-field select:focus, .sah-field textarea:focus { border-color: var(--accent); box-shadow: 0 0 0 3px rgba(249,115,22,0.14); }
...
.sah-field-err { color: #dc2626; font-size: 0.76rem; font-weight: 600; display: flex; align-items: center; gap: 5px; margin-top: 3px; padding: 5px 10px; background: #fff0f0; border-radius: 5px; border-left: 3px solid #dc2626; animation: sah-err-in 0.18s ease; }
...
.sah-prefix-wrap:focus-within { border-color: var(--accent); box-shadow: 0 0 0 3px rgba(249,115,22,0.14); }
...
.sah-pw-strength { margin-top: 6px; }
.sah-pw-strength-bar { height: 4px; border-radius: 2px; background: rgba(0,0,0,0.08); overflow: hidden; margin-bottom: 4px; }
.sah-pw-strength-fill { height: 100%; border-radius: 2px; transition: width 0.3s, background 0.3s; }
.sah-pw-strength-text { font-size: 0.72rem; font-weight: 600; }
.sah-check-group { display: flex; flex-wrap: wrap; gap: 8px; margin-top: 2px; }
.sah-check-group label { display: inline-flex; align-items: center; gap: 7px; padding: 8px 14px; border-radius: 6px; border: 1.5px solid var(--border); background: var(--card-white); font-size: 0.84rem; font-weight: 600; color: var(--mid); cursor: pointer; transition: all 0.14s; text-transform: none; letter-spacing: 0; }
...
.sah-check-group label:has(input:checked) { border-color: var(--accent); background: rgba(249,115,22,0.08); color: var(--accent); }
...
.sah-day-quickpick-btn.active { border-color: var(--accent); background: rgba(249,115,22,0.10); color: var(--accent); }
...
.sah-secondary-toggle.active { border-color: var(--accent); background: rgba(249,115,22,0.08); color: var(--accent); }
...
.sah-file-item { display: flex; align-items: center; gap: 10px; padding: 9px 12px; background: var(--card-white); border: 1px solid var(--border); border-radius: 6px; font-size: 0.82rem; }
...
.sah-add-others-btn { display: inline-flex; align-items: center; gap: 7px; padding: 9px 16px; border-radius: 6px; border: 1.5px dashed rgba(0,0,0,0.18); background: transparent; font-family: 'DM Sans', sans-serif; font-size: 0.84rem; font-weight: 600; color: var(--mid); cursor: pointer; transition: all 0.14s; }
...
.sah-add-others-option:hover { background: rgba(249,115,22,0.07); color: var(--accent); }
...
.sah-nav-prev { display: inline-flex; align-items: center; gap: 8px; padding: 10px 22px; border-radius: 50px; border: 1.5px solid rgba(0,0,0,0.15); background: var(--card-white); color: var(--mid); font-weight: 700; font-size: 0.88rem; font-family: 'DM Sans', sans-serif; cursor: pointer; transition: all 0.15s; }
...
.sah-nav-next { display: inline-flex; align-items: center; gap: 8px; padding: 10px 28px; border-radius: 50px; border: none; background: var(--accent); color: #fff; font-weight: 700; font-size: 0.92rem; font-family: 'DM Sans', sans-serif; cursor: pointer; transition: background 0.15s, transform 0.15s; box-shadow: 0 6px 20px -4px rgba(249,115,22,0.45); }
...
@media (max-width: 700px) {
  ...
  .sah-step-card-head h2 { font-size: 1.15rem; }
  ...
  .sah-terms-box-head-title { font-size: 0.82rem; }
  .sah-step-trail { gap: 3px; }
  .sah-trail-dot { padding: 5px 8px; font-size: 0.68rem; }
  .sah-trail-dot .sah-tn { display: none; }
  .sah-trail-arrow { margin: 0 2px; font-size: 0.55rem; }
  .sah-check-group label { font-size: 0.78rem; padding: 7px 10px; }
  .sah-reg-hero-title { font-size: clamp(1.5rem, 5vw, 2.2rem); margin-bottom: 18px; }
  .sah-nav-prev { padding: 10px 16px; font-size: 0.82rem; }
  .sah-nav-next { padding: 10px 20px; font-size: 0.85rem; }
}
@media (max-width: 480px) {
  ...
  .sah-step-card-head h2 { font-size: 1rem; }
  .sah-plan-card-head { padding: 14px 14px 10px; }
  .sah-plan-price { font-size: 1.3rem; }
  .sah-form-nav-wrap { padding: 12px; }
  .sah-nav-prev, .sah-nav-next { font-size: 0.78rem; padding: 9px 14px; }
  .sah-trail-dot { padding: 4px 7px; font-size: 0.63rem; }
  .sah-check-group label { font-size: 0.74rem; padding: 6px 8px; }
...
const triggerPaystackPayment = async ({ email, amount, planName, onSuccess, onCancel }) => {
  ...
  const handler = window.PaystackPop.setup({
    ...
    metadata: { plan: planName, custom_fields: [{ display_name: 'Plan', variable_name: 'plan', value: planName }] },
...
const PLANS = [
  {
    ...
    paystackAmount: 0,
    features: [
      { t: 'Company logo', y: true },
      { t: 'Short description', y: true },
      { t: 'Contact form (clickable)', y: true },
      { t: 'Social media handles', y: true },
      { t: 'Direct contact details', y: false },
      { t: 'Newsletter inclusion', y: false },
    ],
    cta: 'Get Started Free',
  },
  {
    id: 'pro', name: 'Parental Plus+', desc: 'Full profile + direct contact details', price: 'R149',
    param: 'Parental Plus+ – R149/month',
    paystackAmount: 14900, // in kobo/cents (ZAR × 100)
    highlight: true,
    features: [
      { t: 'Company logo', y: true },
      { t: 'Short description', y: true },
      { t: 'Contact details (tel, email, address, website) — clickable', y: true },
      { t: 'Social media handles', y: true },
      { t: 'Monthly newsletter inclusion', y: true },
      { t: '1x Facebook & Instagram post', y: true },
      { t: '1x Native article (800 words) with image & bio', y: true },
    ],
...
const planToTier = (param) => {
  if (param?.includes('R149') || param?.includes('Parental Plus')) return 'pro';
  return 'free';
};
...
const Registration = () => {
  ...
  const submit = async () => {
    ...
    const selectedPlan = PLANS.find(p => p.param === data.listingPlan);

    // ── For paid plans: collect payment BEFORE creating the profile ──────────
    if (selectedPlan?.paystackAmount > 0) {
      ...
      await new Promise((resolve) => {
        triggerPaystackPayment({
          ...
          onSuccess: (res) => {
            ...
            showNotification?.(`💳 Payment successful! Ref: ${res.reference}`, 'success');
            resolve();
          },
          onCancel: () => {
            showNotification?.('Payment cancelled — profile not created. Please try again and complete payment.', 'error');
            resolve();
          },
        }).catch(() => resolve());
      });

      if (!paymentConfirmed) return; // stop — don't create profile
    }
      ...
      <div className="sah-terms-box">
        <div className="sah-terms-box-head" onClick={() => setTermsOpen(o => !o)}>
          <div className="sah-terms-box-head-title">
            ...
            Parentals — Terms & Community Guidelines
          </div>
        ...
        <div className={`sah-terms-body ${termsOpen ? 'open' : 'closed'}`}>
          ...
          <p>Any qualifications, certifications, police clearances, or memberships listed must be legitimate and verifiable upon request. Parentals reserves the right to request proof of credentials at any time.</p>
          ...
          <p>All new profiles are subject to admin review before going live. Parentals reserves the right to reject or remove any listing that does not meet our community standards.</p>
          ...
          <h4>8. Liability</h4>
          <p>Parentals acts as a directory platform and is not responsible for the quality, safety, or outcome of services provided by listed providers. Families are encouraged to conduct their own due diligence.</p>
          <h4>9. Amendments</h4>
        ...
        <div className="sah-rhdr-inner">
          <div className="sah-rhdr-left">
            ...
            <Link to="/" className="sah-rhdr-brand">
              <span className="sah-rhdr-brand-name">Parentals</span>
